This guide will walk you through the simple steps needed to build and run an Image Processing app using TensorFlow using GPU on Rising Cloud. 
...
risingcloud init --gpu $GPU_TYPE $TASK_URL
...
For this example, we will use a pretrained Keras model to run predictions on user input. In your project directory, create a file named “train.py”, and in it, write the following contents:
